...
- The shooter of the previous pass can not be the receiver of the current pass (this means you need *at least 3 robots*).
- A pass must be directed at least *10°* away from where the previous pass came from.
